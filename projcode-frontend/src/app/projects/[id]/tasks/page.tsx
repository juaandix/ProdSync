        ...
        <div className="flex justify-between items-center mb-4">
          ...
          <RoleGuard roles={['ADMIN', 'OPERATOR']}>
            <button
              ...
              className="px-4 py-2 bg-[#E93222] text-white rounded-md hover:bg-[#C72C1F] focus:outline-none focus:ring-2 focus:ring-[#E93222]/50 focus:ring-offset-2"
            >
              Create New Task
            </button>
          </RoleGuard>
              ...
              <div key={task.id} className="p-4 border rounded-md bg-gray-50 dark:bg-gray-700">
                ...
                <div className="mt-4 flex items-center gap-2">
                  <button
                    ...
                    className="px-3 py-1 text-sm bg-[#E93222] text-white rounded-md hover:bg-[#C72C1F]"
                  >
                    Log Time
                  </button>
                  <Link
                      ...
                      {timeEntries.filter(entry => entry.taskId === task.id).length === 0 ? (
                        ...
                        timeEntries.filter(entry => entry.taskId === task.id).map((entry) => (
                          <div key={entry.id} className="flex items-center gap-3 p-2 bg-white dark:bg-gray-600 rounded-md">
                            <div className="h-[36px] w-[36px] flex items-center justify-center rounded-full bg-[#E93222] text-white font-semibold text-sm flex-shrink-0">
