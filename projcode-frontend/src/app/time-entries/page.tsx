                        ...
                        {info?.projectId ? (
                          <Link href={`/projects/${info.projectId}/tasks`}>
                            <div className="flex items-center gap-3">
                              <div className="h-[40px] w-[40px] flex items-center justify-center rounded-md bg-[#E93222] text-white font-semibold text-base flex-shrink-0">
        ...
        <div className="p-6">
          ...
          <form onSubmit={handleEditSubmit} className="space-y-4">
            ...
            <div className="flex justify-end gap-4">
              ...
              <button type="submit" disabled={updateMutation.isPending} className="px-4 py-2 bg-[#E93222] text-white rounded-full hover:bg-[#C72C1F] disabled:opacity-50">
