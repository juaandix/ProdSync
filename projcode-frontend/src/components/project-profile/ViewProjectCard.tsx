...
export default function ViewProjectCard({ id }: ViewProjectCardProps) {
  ...
  return (
    <Card className="w-full overflow-hidden rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] sm:p-6">
      <CardHeader className="pb-4">
        <div className="flex justify-between items-start">
                      <div className="flex items-center gap-3">
                        <div className="h-[40px] w-[40px] flex items-center justify-center rounded-md bg-[#E93222] text-white font-semibold text-lg flex-shrink-0">
        ...
        {project.client && (
          <div className="pt-4">
            <Link href={`/clients/${project.client.id}`} className="flex items-center gap-3">
              <div className="h-[40px] w-[40px] flex items-center justify-center rounded-full bg-[#E93222] text-white font-semibold flex-shrink-0">
