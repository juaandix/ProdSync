...
const inputClass = (hasError: boolean) =>
  `h-11 w-full rounded-lg border px-4 py-2.5 text-sm bg-transparent text-white placeholder:text-gray-400 focus:outline-none focus:ring-3 ${
    hasError
      ...
      : "border-gray-300 focus:border-[#E93222] focus:ring-[#E93222]/20"
  }`;
        ...
        <div className="w-full max-w-md bg-[#1E1E26] dark:bg-[#1E1E26] p-6 rounded-lg">
          ...
          <div className="py-8 flex justify-center">
            <Link href="/" className="flex items-center gap-2">
              <Image src="/images/logo.png" alt="Softcode Logo" width={64} height={64} />
              <div className="flex flex-col items-center gap-y-0">
                <span className="text-5xl font-bold text-white">Softcode</span>
                <span className="text-lg whitespace-nowrap -mt-1 text-white">
          ...
          <form onSubmit={handleSubmit(onSubmit)} noValidate>
            <div className="space-y-5">
              ...
              <button
                ...
                className="w-full bg-[#E93222] text-white hover:bg-[#C72C1F] disabled:opacity-60 rounded-md px-4 py-2 text-sm font-medium transition-colors"
              >
