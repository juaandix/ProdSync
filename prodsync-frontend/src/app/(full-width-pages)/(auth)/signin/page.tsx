              ...
              <div>
                ...
                <div className="relative py-3 sm:py-5">
                  ...
                  <div className="relative flex justify-center text-sm">
                    <span className="p-2 text-[#A7ABB4] bg-white sm:px-5 sm:py-2">
                      Or
                    </span>
                  </div>
                </div>
                <form onSubmit={handleSubmit}>
                  <div className="space-y-6">
                    ...
                    <div>
                      <button className="w-full bg-[#1E1E26] text-white hover:bg-[#13131a] rounded-md px-4 py-2 text-sm font-medium transition-colors">
                        Sign in
                      </button>
                    </div>
                  </div>
                ...
                <div className="mt-5">
                  <p className="text-sm font-normal text-center text-gray-600 sm:text-start">
